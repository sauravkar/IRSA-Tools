...
public class Layout extends Panel implements IWiQueryPlugin {
    ...
    /**
     * Method to override to specify the CenterArea Wicket component
     *
    ...
    /**
     * Method to override to specify the EastArea Wicket component
     *
     * @param wicketId Wicket identifiant
     * @return the component
     */
    ...
    /**
     * Method to override to specify the WestArea Wicket component
     *
     * @param wicketId Wicket identifiant
     * @return the component
     */
    ...
    */
     ...
     * @return instance of the current component
     */
    public Layout setSize(int maxSize) {
        options.put("size", maxSize);
        return this;
    }

    public Layout setSize(PanePositionEnum pane, int size) {
        options.put(pane + "__size", size);
        return this;
    }

    /**
     * Returns the component's initial size.
     */
    public int getSize() {
        if (this.options.containsKey("size")) {
            return options.getInt("size");
        }
    ...
    /**
     * Add js and css resources to header
     *
     * @param response
     */
    @Override
    public void renderHead(IHeaderResponse response) {
        response.renderCSSReference(LayoutStyleSheetResourceReference.get());
        response.renderJavaScriptReference(LayoutJavascriptResourceReference.get());
    }
